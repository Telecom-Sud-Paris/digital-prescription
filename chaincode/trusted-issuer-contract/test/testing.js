...
const org1UserId = 'issuer-test-user';
...
async function main() {
    ...
    try {
        ...
        const check = await contract.evaluateTransaction('initLedger');
        console.log(`${check.toString()}`);

        // const precription = await contract.evaluateTransaction("queryAllRules");
