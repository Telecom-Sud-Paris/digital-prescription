  ...
  <div class="min-h-screen bg-slate-50 pt-12 pb-24 px-4 sm:px-6 lg:px-8">
    <div class="max-w-xl mx-auto">
      ...
      <div v-if="!isLoggedIn" class="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
        <h3 class="text-lg font-medium text-slate-900 mb-4">Professional Access</h3>
        <p class="text-sm text-slate-500 mb-6">Insert your DID to simulate authentication via Wallet.</p>
      ...
      <div v-else>
        ...
        >
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1">Refills Allowed</label>
            ...
            <div>
              <label class="block text-sm font-medium text-slate-700 mb-1">Prescription Validity</label>
      ...
      <Modal :isOpen="!!offerUrl" @close="resetFormAndModal">
        <div class="text-center">
          ...
          <p class="text-xs text-slate-500 mt-1">Your digital prescription is ready.</p>
...
const login = () => {
  if(doctorDid.value.trim() !== '') isLoggedIn.value = true
}
